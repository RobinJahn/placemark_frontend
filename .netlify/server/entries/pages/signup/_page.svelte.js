...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${validate_component(Header, "Header").$$render($$result, { subTitle: "Sign Up" }, {}, {
    default: () => {
...
<div class="columns"><div class="column"><div class="box"><h1 class="title">Signup</h1>
    ...
    <div class="column has-text-centered"><img class="box" alt="suitcase" src="/Suitcase1.png" width="600"></div></div>`;
});
export {
  Page as default
};
